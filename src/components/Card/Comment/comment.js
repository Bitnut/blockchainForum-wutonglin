...
class Comment extends Component {
    ...
    _initTimeString () {
        ...
        const duration = (+Date.now() - comment.createdTime) / 60000 // 发布分钟数
        if (duration < 1) {
            ...
            this.setState({timeString: FormatTime("yyyy-MM-dd hh:mm", comment.createdTime)})
        }
    }
    // 实时更新时间方法
    _updateTimeString () {
        ...
        return (
            <div className='comment-reply-wrapper'>
                <div className='comment'>
                    ...
                    <div className='right'>
                        <span><h2>{this.props.comment.username}：</h2> </span>
